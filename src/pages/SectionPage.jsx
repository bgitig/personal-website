  ...
  return (
    <div
      ...
      onMouseEnter={e => {
        ...
        e.currentTarget.style.background = 'linear-gradient(160deg, #341e0c 0%, #2a180a 100%)'
      }}
      onMouseLeave={e => {
        e.currentTarget.style.borderColor = 'rgba(160,120,50,0.2)'
        e.currentTarget.style.background = 'linear-gradient(160deg, #2a1c0c 0%, #221608 100%)'
      }}
    >
      {/* image thumbnail */}
      <div style={{
