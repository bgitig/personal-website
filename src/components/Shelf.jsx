...
export default function Shelf({ label, slots, leftWing, rightWing }) {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0 }}>
      ...
      <Link
        ...
        onMouseLeave={e => e.currentTarget.style.color = 'rgba(180,140,80,0.45)'}
      >
        {label}
      </Link>
      ...
      <div style={{
        ...
        <div style={{ flex: 1, minHeight: 0, display: 'flex' }}>
          ...
          <div style={{
            ...
            {leftWing.map(b => <WingBook key={b.id} data={b} />)}
          </div>
          ...
          <div style={{
            ...
            {slots.map(slot =>
              slot.kind === 'book'
                ...
                : <ShelfObject key={slot.data.id} data={slot.data} />
            )}
          </div>
          ...
          <div style={{
            ...
            {rightWing.map(b => <WingBook key={b.id} data={b} />)}
          </div>
        </div>
        ...
        <div style={{
          ...
          boxShadow: '0 4px 18px rgba(0,0,0,0.85), inset 0 2px 4px rgba(255,255,255,0.05)',
